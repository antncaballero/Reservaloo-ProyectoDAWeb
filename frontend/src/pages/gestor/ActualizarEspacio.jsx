...
const ActualizarEspacio = () => {
  ...
  return (
    <>
      <Header title="Actualizar Espacio" />
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto">
          <form onSubmit={handleSubmit} className="space-y-6 text-xs md:text-sm font-medium text-white">
            <section>
              <label
                htmlFor="nombre"
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2 border border-white rounded-md focus:border-secondary"
                >
                  <option className="text-primary font-medium" value="ACTIVO">
                    Activo
                  </option>
                  <option className="text-primary font-medium" value="CERRADO">
                    Cerrado
                  </option>
                </select>
              </div>
