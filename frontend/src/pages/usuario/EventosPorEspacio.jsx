...
const EventosPorEspacio = () => {
  ...
  if (loading)
    return (
      <div className="min-h-screen mt-50 animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-primary"></div>
    );
    ...
    return (
      <div className="min-h-screen flex flex-col justify-center items-center text-center px-4">
        ...
        <p className="text-lg mb-6">
          {error || "Parece que no se encontró el espacio buscado..."}
        </p>
        <Link
          to="/espacios"
          className="text-primary bg-white py-2 px-4 rounded-lg hover:bg-white/80 transition-colors"
        >
          Volver a espacios
        </Link>
      </div>
  ...
  return (
    <div className="container mx-auto px-4 py-8 mt-16">
      <header className="bg-white rounded-lg shadow-lg p-6 mb-8 flex flex-col md:flex-row md:items-center justify-between mb-4">
        <div>
      ...
      {eventos.length === 0 ? (
        <section className="bg-white rounded-lg shadow-lg p-8 text-center">
          <p className="text-xl text-gray-600 mb-4">
            No hay eventos programados próximamente en este espacio.
          </p>
